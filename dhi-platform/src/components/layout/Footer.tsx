            ...
            <div className="flex items-center gap-2">
              {[
                ...
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="w-9 h-9 rounded-xl bg-white/8 hover:bg-white/15 flex items-center justify-center text-white/65 hover:text-white transition-colors"
                >
                  {s.icon}
                </a>
              ))}
        ...
        <div className="border-t border-white/6 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5">
            {["Privacy", "Terms", "Contact"].map((t) => (
              <a key={t} href="#" className="text-xs text-white/45 hover:text-white/80 transition-colors">
                {t}
              </a>
            ))}
          </div>
