...
export function CTASection() {
  return (
    <section data-theme="dark" className="relative bg-[#080d25] py-24 sm:py-28 lg:py-32 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-white/70 max-w-md mx-auto mb-12 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="/#initiatives"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 border border-white/25 hover:border-white/50 text-white/85 hover:text-white text-sm font-medium rounded-full transition-all w-full sm:w-auto"
            >
              Explore Platform
            </Link>
          </div>
